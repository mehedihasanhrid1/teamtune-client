...
const Profile = () => {
  ...
  return (
    <div className="flex items-center justify-center w-full md:w-[44rem] lg:w-[60rem]">
      <div className="py-4 w-full lg:py-6 bg-gray-300 dark:bg-gray-800 rounded-lg shadow-lg flex items-center justify-center">
