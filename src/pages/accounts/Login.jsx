            ...
            <form action="">
              ...
              <div className="mb-4 lg:mb-7">
                <div className="relative flex items-center">
                  ...
                  />
                   <svg onClick={()=> setShowPassword(!showPassword)} xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                    className="absolute right-0 mr-4 dark:text-gray-300 cursor-pointer" fill="currentColor"
                                    viewBox="0 0 16 16">
                                    <path
              ...
              <button
                className="w-full px-4 py-4 text-sm font-bold text-gray-100 uppercase bg-blue-600 rounded-md lg:text-lg dark:text-gray-300 dark:bg-blue-800 hover:bg-blue-700 dark:hover:bg-blue-900"
                type="submit"
              >
                LOGIN
              </button>
