      ...
      <div className="w-full bg-gray-100 border-t dark:border-gray-900 py-4 dark:bg-gray-900">
        <div className="max-w-6xl mx-auto px-0 md:px-8 xl:px-0">
          <div className="justify-center flex-1 max-w-6xl px-4 py-2 mx-auto lg:py-0">
            <div className="flex flex-wrap py-4 -mx-3">
              ...
              <div className="w-full px-4 mb-7 md:w-1/2 lg:w-4/12 lg:mb-0">
                <a
                  href="#"
                  className="inline-block pb-2 text-lg font-bold text-gray-700 dark:text-gray-300"
                >
                  About Company
                </a>
                <div className="w-16 mb-4 border-b-2 border-blue-600 dark:border-gray-600"></div>
                <p className="text-base font-normal text-gray-600 leading-6 lg:w-64 dark:text-gray-400 pr-8">
                Elevate your workforce with seamless collaboration. Our employee management platform ensuring efficiency, and fostering team synergy.
                </p>
              </div>

              {/* Quick Links */}
              <div className="w-full px-4 md:w-1/4 lg:w-2/12 mb-7 lg:mb-0">
                <h2 className="pb-2 text-lg font-bold text-gray-700 dark:text-gray-300 ">
                  Quick Links
                </h2>
                <div className="w-16 mb-4 border-b-2 border-blue-600 dark:border-gray-600"></div>
          ...
          <div className="flex flex-wrap items-center justify-between px-4 mb-4">
            <h2 className="mb-4 text-2xl font-semibold tracking-wider text-gray-700 lg:mb-0 dark:text-gray-300">
